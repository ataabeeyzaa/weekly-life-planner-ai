...
| AI | Google Gemini 1.5 Flash | API v1 | Ücretsiz tier (1500 istek/gün, 1M token/gün), kredi kartı yok, Türkçe iyi |
| AI yedek | OpenAI gpt-4o-mini | API v1 | Eğer Gemini limit aşımı olursa, $0.15 / 1M input |
...
| `model_kullanilan` | TEXT | DEFAULT 'gemini-1.5-flash' | Hangi LLM |
...
### Gemini Parametreleri (primary)

- Model: `gemini-1.5-flash` (veya `gemini-2.0-flash-exp` daha yeni)
- Temperature: `0.4` (tutarlı ama yaratıcı)
- Max output tokens: `2000`
- Response MIME type: `application/json`
- System instruction: yukarıdaki system prompt
- n8n node: "Google Gemini Chat Model" (LangChain) veya "Google Gemini"

### OpenAI Parametreleri (fallback)
